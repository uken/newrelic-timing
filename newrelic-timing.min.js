...
!function(a){a.NewrelicTiming=function(){this.marks={},this.mark=function(a){this.marks[a]=+new Date},this.measure=function(a,b){var c,d;return b?(d=this.marks[b],c=this.marks[a]):(d=this.marks[a],c=+new Date),c-d},this.sendNRBeacon=function(b){if(this.checkBeaconRequirements()){b||(b=a.location.hash.substring(1));var c=this.measure("domLoaded","navStart"),d=this.measure("pageRendered","navStart");a.NREUM.inlineHit(b,0,0,0,c,d)}},this.checkBeaconRequirements=function(){return a.NREUM&&a.NREUM.inlineHit&&"function"==typeof a.NREUM.inlineHit?this.marks.navStart&&this.marks.domLoaded&&this.marks.pageRendered:!1}}}(window);